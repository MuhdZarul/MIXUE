...
<table class="table table-bordered">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{ $transaction->delivery->id }}</td>
            <td>{{ ucfirst($transaction->status) }}</td>
            <td>
                <!-- Edit Button -->
                <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#editTransactionModal-{{ $transaction->transaction_id }}">Edit</button>
        ...
        <div class="modal fade" id="editTransactionModal-{{ $transaction->transaction_id }}" tabindex="-1" aria-hidden="true">
